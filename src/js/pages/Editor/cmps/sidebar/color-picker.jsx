...
export const ColorPicker = ({isBackgroundColor}) => {
  //use memo
  const [color, setColor] = useState({ color: '#FFFFFF',background: '#FFFFFF' })
  ...
  const onChangeColor = (colorInput) => {
    ...
    const newColor = (isBackgroundColor) ? {background: colorInput} : {color: colorInput}
      ...
      <div className='colors-container'>
        ...
        >
          ...
          <input
            ...
            type='color'
          />
          {!isBackgroundColor ? <ColorizeIcon
            style={{
              borderRadius: '50px',
            }}
          /> : 
