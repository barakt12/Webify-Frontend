...
export function PagingGallery({ cmp, onHoverCmp, selectedCmp, onSelectCmp }) {
    ...
    <div className={`paging-gallery-container`}>
      ...
      >
        ...
        <div className='img-container'>
          <img
            src={imgLinks[currImg === 0 ? imgLinks.length - 1 : currImg - 1]}
          />
        </div>
        <div className='img-container'>
        ...
        <div className='img-container'>
          <img
            src={imgLinks[currImg === imgLinks.length - 1 ? 0 : currImg + 1]}
          />
        </div>
        <svg
          onClick={() => {
