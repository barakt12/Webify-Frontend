...
const wapTemplates = [wapTemplate1, wapTemplate2, wapTemplate3, wapTemplate4]

const mapCmpByCategory = {
  header: [headerWap1, headerWap2, headerWap3, headerCmp4],
  hero: [wapHero1, wapHero2, heroCmp4],
  card: [wapCards1],
  section: [wapSection1, wapSection2, sectionCmp3],
  gallery: [wapCarousel1, wapCarousel2, wapGallery1, galleryCmp2],
  text: [wapText1],
  video: [wapVideo1],
  form: [wapContact1, formCmp3],
  footer: [wapFooter1, wapFooter2, wapFooter3, footerCmp4],
}
